  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <input
        ...
        className="w-full pl-12 pr-12 py-3 bg-slate-800/80 text-white rounded-lg border border-slate-700 focus:border-orange-400 focus:ring-2 focus:ring-orange-400/20 focus:outline-none transition-all"
        value={localValue}
