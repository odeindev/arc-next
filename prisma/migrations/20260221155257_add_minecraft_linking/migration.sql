...
-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('subscription', 'key');

-- CreateEnum
CREATE TYPE "Duration" AS ENUM ('DAYS_30', 'DAYS_60', 'DAYS_90');
...
-- CreateIndex
CREATE UNIQUE INDEX "MinecraftAccount_username_key" ON "MinecraftAccount"("username");

-- CreateIndex
CREATE UNIQUE INDEX "MinecraftAccount_authUUID_key" ON "MinecraftAccount"("authUUID");
