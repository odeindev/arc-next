...
export const products: Product[] = [
  {
    ...
    benefits: [
      ...
      "Предметы в /kit ghost обновляются каждые 24 часа",
    ],
  ...
  },
  {
    ...
    benefits: [
      "Доступ к /kit hero",
      "Возможность установки 4 точек дома",
      "Команда /feed для мгновенного насыщения",
      "Доступ к эндер-сундуку через команду /enderchest",
    ],
  ...
  },
  {
    ...
    benefits: [
      "Доступ к /kit titan",
      "Возможность установки 6 точек дома",
      "Команда /heal для восстановления здоровья",
      "Полный доступ к цветным никам",
    ],
  ...
  },
  {
    ...
    benefits: [
      "Доступ ко всем наборам",
      "Возможность установки 10 точек дома",
      "Команды /heal, /feed, /fly",
      "Эксклюзивные предметы и возможности",
    ],
